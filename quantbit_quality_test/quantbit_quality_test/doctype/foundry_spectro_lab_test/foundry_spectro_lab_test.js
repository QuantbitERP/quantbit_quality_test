...
// frappe.ui.form.on("Foundry Spectro Lab Test", {
// 	refresh(frm) {
    ...
    pouring_id: function(frm) {
            frappe.call({
                ...
                callback: function(r) {
                    if (r.message) {
                        var k = r.message;
                        frm.set_query("item_code", "spectro_details", function(doc, cdt, cdn) {
...
frappe.ui.form.on('Foundry Spectro Lab Test Details', {
